    ...
    public sealed class Foo : IDisposable
    {
        ...
        public void Dispose()
        {
            this.bar.Dispose();
                ...
                AnalyzerAssert.CodeFix(Analyzer, CodeFix, ExpectedDiagnostic, new[] { DisposableCode, subclassCode, testCode }, fixedCode);
                AnalyzerAssert.FixAll(Analyzer, CodeFix, ExpectedDiagnostic, new[] { DisposableCode, subclassCode, testCode }, fixedCode);
            }
